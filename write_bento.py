...
const MainContent = () => (
  <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.2 }} style={{ background: 'rgba(255, 255, 255, 0.95)', borderRadius: '12px', border: '1px solid rgba(200, 200, 200, 0.3)', boxShadow: '0 2px 12px rgba(0, 0, 0, 0.08)', padding: '2rem', minHeight: '600px' }}>
